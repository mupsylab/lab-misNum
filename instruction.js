function instruction() { 
    ...
    let instr = {
        ...
        pages: [
            ...
            <p class='para'>实验说明：</p>\
            <p class='para'>您好，欢迎参加本次实验。本次实验需要两天时间，每天80分钟，共160分钟完成。</p>\
            <p class='para'>任务概况</p>\
            <p class='para'>本次实验的两天里，您均需要知觉匹配任务。</p>\
            <p class='para'>具体来说，在实验中，您需要注视电脑屏幕的中央及屏幕上出现的视觉内容。屏幕上首先出现一个“+”，很快，“+”上方面会出现一个几何图形中，下方会出现文字信息。几何图形可能是正方形、圆形、三角形和五边形，文字是几何图形对应的形状名称（实验1），或者是我们预先让您学习的具有对应相关的人物标签（实验2）。您的任务是判断几何图形与图形名称或人物标签是否匹配；匹配按屏幕一侧，不匹配按另一侧。（详细见每次实验的指导语）</p>\
